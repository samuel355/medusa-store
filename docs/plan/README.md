...
| 4 | [commerce-004](tasks/commerce-004.md) | Move checkout and Paystack into Medusa | blocked |
| 5 | [commerce-005](tasks/commerce-005.md) | Consolidate customer identity and account reads | pending |
